...
var floor3Id = "59b01566138ae0871a99efdc"
var floor4Id = "59b042df138ae0871a99f9a1"
var floor5Id = "59b0126b138ae0871a99eccf"
var buildingId = "59b0126b138ae0871a99ecce"
...
$.ajax({
    type:"GET",
    url:"/reportApi/buComparisonPlot/59b0126b138ae0871a99ecce?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
...
$.ajax({
    ...
    url: "/reportApi/healthPattern/59b0126b138ae0871a99ecce?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
...
$.ajax({
    type:"GET",
    url:"/reportApi/roomUtil/" + buildingId + "?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
    success:function(response){
        var datas = response;
        var i=1;
        datas.forEach(function(data){
...
$.ajax({
    ...
    success:function(response){
        ...
        var i=1;
        datas.forEach(function(data){
            if($('#temp-util'+i).highcharts(tempPattern))
            {
...
$.ajax({
    type:"GET",
    url:"/reportApi/utilData/" + floor3Id + "?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
    success:function(response){
        // console.log(data)
            ...
            $.ajax({
                type:"GET",
                url:"/reportApi/utilData/"+ floor4Id +"?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
                success:function(response){
                    // console.log(data)
                ...
                $.ajax({
                type:"GET",
                url:"/reportApi/utilData/"+ floor5Id +"?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
                success:function(response){
                    // console.log(data)
                ...
                var totalHours = response.totalHours;
                        totalSeats= seatCountf1 +seatCountf7 +seatCountf8
                        totalUnused = unusedSeatsf1 + unusedSeatsf7 + unusedSeatsf8 
                        totalHourSeat1 = hourSeats1f1 + hourSeats1f7 + hourSeats1f8 
                        totalHourSeat2 = hourSeats2f1 + hourSeats2f7 + hourSeats2f8
                        totalHourSeat3 = hourSeats3f1 + hourSeats3f7 + hourSeats3f8
...
$.ajax({
    ...
    //dataType: "json",
    //contentType:"application/x-www-form-urlencoded; charset=utf-8",
    url: "/reportApi/occupancyPattern/" + buildingId + "?eday="+eday+"&emonth="+emonth+"&eyear="+eyear+"&sday="+sday+"&smonth="+smonth+"&syear="+syear,
    success: function(msg) {
        labelData = msg.labels
        //console.log(labelData)
        console.log(msg)
