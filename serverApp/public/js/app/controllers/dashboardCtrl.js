app.controller('dashboardCtrl', ['$rootScope', '$scope', '$timeout', '$mdSidenav', '$state', '$interval', '$http', 'mapStyles', function($rootScope, $scope, $timeout, $mdSidenav, $state, $interval, $http, mapStyles) {
