app.controller('changePasswordCtrl',['$scope', '$rootScope', '$http', 'ChangePassword', function ($scope, $rootScope, $http,ChangePassword){
    $rootScope.userContent();
  
    $scope.changePassword = function()
    {
        console.log($scope.user);
        $http.post('app/api/changePassword', $scope.user).then(function(response){
